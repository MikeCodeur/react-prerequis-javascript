...
// 🐶 Créé un object `terrainFoot` avec les propietes `longeur` et `largeur` initialisés avec les constantes ci-dessus 
// en utilisant les shorthand property names

// 🐶 Créé un object `terrainBasket` avec les propietes `longeur` 28 et `largeur` 15 (sans créer de variables intermédiaires)
