...
const QCM: Array<IQCMInterface> = [
  {
    ...
    quiz: [
      {
        question: "Quelle est l'utilisation recommandée pour déclarer une variable name qui peut changer de valeur ?",
        options: ["name = 'Mike'", "var name = 'Mike'", "const name = 'Mike'", "let name = 'Mike'"],
        answer: "3"
      },{
        question: "Peut-on exporter plusieurs fonctions par defaut dans un module ?",
        options: ["Oui", "Non"],
        answer: "1"
      },{
    ...
    quiz: [
      {
        ...
        options: ["Des doubles quotes :  \"Hello World\" ", "Des simples quotes :  'Hello World'", "Des backquotes `Hello World`",],
        answer: "2"
      },{
    ...
    quiz: [
      {
        ...
        options: ["const <nom, prenom, age, ville> = personne", "const {.nom, .prenom, .age, .ville} = personne", "const {nom, prenom, age, ville} = personne"],
        answer: "2"
      },{
        question: "Je veux destructuer un array :\n const toto = [\"un\", \"deux\", \"trois\"]",
        options: ["const {un, deux, trois, ville} = toto", "const [un, deux, trois] = toto", "const [un:un, deux:deux, trois:trois] = toto;", "destruct(toto)"],
        answer: "1"
      } 
    ],
    ...
    quiz: [
      {
        ...
        options: ["const somme = (a, b) => a + b", "const somme = (a, b) => (a + b)", "const somme = (a, b) => {a + b}" , "const somme = (a, b) => {return a + b}"],
        answer: "2"
      },{
        question: "Soit : const somme = (a = 5, b = 10) => a + b | Trouver l'erreur ",
        options: ["somme() vaut 15", "somme(0) vaut 10", "somme(5, 5) vaut 10", "somme(10) vaut 10"],
        answer: "3"
      } 
    ],
  },
    ...
    quiz: [
      {
        ...
        options: ["?.personne.adresse.ville", "personne.adresse?.ville", "personne?.adresse?.ville", "personne??.adresse??.ville"],
        answer: "2"
      },{
        question: "let person = name ?? 'anonyme' veut dire ? ",
        options: ["person vaut 'anonyme' si null ", "person vaut 'anonyme' si null ou undefined", "person vaut 'anonyme' toujours", "person vaut 'name'toujours"],
        answer: "1"
      },{
        question: "La bonne syntaxe d'une ternaire est : ",
        options: ["pageCode == 404 ? 'page not found' : 'page found'  ", "pageCode == 404 : 'page not found' ? 'page found'", "pageCode = 404 ? 'page not found' : 'page found'", "pageCode == 404 / 'page not found' : 'page found'"],
        answer: "1"
      } 
    ],
  },
    ...
    quiz: [
      {
        ...
        options: ["Tous les élements qui remplissent les conditions", "Le premier qui rempli les conditions"],
        answer: "1"
      },{
        ...
        options: ["Un objet", "Un boolean", "Un array", "dépend de la condition"],
        answer: "3"
      },{
